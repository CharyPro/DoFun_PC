...
std::vector<cv::Mat> Filter::process(cv::Mat image)
{
    /******************** 均值滤波 *********************/
    ...
    result.push_back(filter_box);
    result.push_back(filter_gaussian);
    result.push_back(filter_median);
    result.push_back(filter_bila);
    return result;
}
